...
// Sample card from Airbnb
 export function Image3() {
    ...
    const property = {
      imageUrl: "https://res.cloudinary.com/urbanclap/image/upload/t_low_res_portfolio_medium,q_auto:low,f_auto/images/growth/luminosity/1646140571372-aa78b8.png",
      imageAlt: 'Hair Studio For Women',
